...
def possible_neighbours(heightmap, pos):
  x,y = pos
...
def shortest_path(heightmap, start, end):
  ...
  pos = start
  while pos != end:
    for neigh in possible_neighbours(heightmap, pos):
...
assert possible_neighbours(['abc','def','ghi'], (0,0)) == [(0,1)]
assert possible_neighbours(['abc','def','ghi'], (1,1)) == [(0,1),(1,0),(1,2)]
assert possible_neighbours(['abc','def','ghi'], (2,2)) == [(1,2),(2,1)]
